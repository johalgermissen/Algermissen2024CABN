...
for (sub in 1:nSubs){
  ...
  ISI <- makeITISequence(nPart,nStim,nRepStim,intercept=1.5,maxSteps=4)
  ITI <- makeITISequence(nPart,nStim,nRepStim,intercept=2.5,maxSteps=4)
